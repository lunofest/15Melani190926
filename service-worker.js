const CACHE_NAME = 'cache-v50'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v50',
    'estilos/styles.css?v50',
    'estilos/mediaQueries.css?v50',
    'javascript/script.js?v50',
