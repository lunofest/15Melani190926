...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '541130669553'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '543865325145'; // Número para el primer botón
  const recipientNumber2 = '543812106652'; // Número para el segundo botón
